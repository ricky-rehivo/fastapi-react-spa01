  ...
  const BtnElement = () => {
    if (isUpdate) {
      return (
        <>
          <InputGroup>
            <Button h="1.5rem" size="sm" onClick={cancelRefresh}>
              キャンセル
            </Button>
            <Button h="1.5rem" size="sm" onClick={updateEvent}>
              更新
            </Button>
            <Button h="1.5rem" size="sm" onClick={deleteEvent}>
              削除
            </Button>
          </InputGroup>
        </>
      ...
      return (
        <>
          <Button h="1.5rem" size="sm" onClick={onClose}>
            キャンセル
          </Button>
          <Button h="1.5rem" size="sm" onClick={addEvent}>
            保存
          </Button>
        </>
      );
